...
tomoe_char   *tomoe_canvas_get_nth_candidate  (TomoeCanvas *canvas,
                                               guint        nth);
...
void          tomoe_canvas_set_database       (TomoeCanvas *canvas,
                                               tomoe_db    *database);
tomoe_glyph  *tomoe_canvas_get_glyph          (TomoeCanvas *canvas);
